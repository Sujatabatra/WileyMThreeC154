...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	try {
		...
		case 3:
			...
			if(courseService.deregisterEmployeeForCourse(courseId, eId))
				System.out.println("Employee Deregistered Succesfully!");
			else
				System.out.println("Employee Deregistered Unsuccessful!");
			break;
		case 4:
			System.out.println("Enter Course ID whoes Employee Registration you want to see :");
			String coId=scanner.next();
			Employee empls[]=courseService.listOfEmployeesForCourse(coId);
